...
import ReadyToProject from "./ReadyToProject";
    ...
    <div className="flex flex-col items-center w-full overflow-x-hidden mt-40">
      ...
      <div
        ...
        <div className="flex flex-row gap-2 text-sm">
          ...
          <span>➙</span>
          <span className="hover:cursor-pointer text-slate-200">Staff Augmentation</span>
        </div>
        ...
        <div className="flex flex-col gap-5 h-full text-white">
          <motion.h1
            ...
            Staff Augmentation Team Services
          </motion.h1>

          <motion.p animate={rightAnimation} className="text-white text-xl">
            Expand your development capabilities by hiring a dedicated team of developers with years
            of experience in the industry you need.
          </motion.p>

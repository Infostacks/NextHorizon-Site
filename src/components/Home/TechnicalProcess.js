        ...
        <div className="flex xl:flex-row items-center flex-col xl:w-1/2 lg:w-1/2 md:w-5/6 w-full ">
          <div className="flex flex-col xl:w-1/2 w-full flex-wrap gap-5">
            <h3 className="xl:text-3xl lg:text-3xl text-xl font-semibold">
              {technicalProcess[count].category}
            </h3>
            <p className="flex flex-wrap text-justify">{technicalProcess[count].desc1}</p>
            ...
            <p className="flex flex-wrap my-5 text-justify">{technicalProcess[count].desc2}</p>
          </div>

          <div className="flex flex-col xl:w-1/2 w-full">
            <img src={technicalProcess[count].img} alt={technicalProcess[count].title} />
          </div>
        </div>
      </div>
    </div>

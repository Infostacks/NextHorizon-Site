    ...
    <div className="flex flex-col items-center w-full overflow-x-hidden mt-40">
      ...
      <div
        ...
        <div className="flex flex-row gap-2 text-sm">
          ...
          <span>➙</span>
          <span className="hover:cursor-pointer text-slate-200">Android development</span>
        </div>
        ...
        <div className="flex flex-col gap-5 h-full text-white">
          ...
          <motion.p animate={rightAnimation} className="text-white text-xl">
            Building and delivering native Android applications of any complexity level using
            platform-specific technologies like Java and Kotlin.
          </motion.p>

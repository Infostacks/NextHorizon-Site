      ...
      <div className="max-w-screen-lg px-4 pt-20 mx-auto">
        ...
        <div className="flex items-center justify-between xl:flex-row lg:flex-row md:flex-row flex-col gap-5 mx-10">
          ...
          <div className="flex flex-col justify-start items-start">
            ...
            <motion.p animate={rightAnimation} className="mt-4 xl:text-3xl lg:text-3xl text-xl">
              Leading rating & review platforms rank Nexxt.ai among top software development
          ...
          {ourRewards.map((reward, index) => {
            return (
              <motion.div
                ...
                <span className="text-lg font-bold text-gray-900">{reward.title}</span>
                <span className="text-lg text-gray-800 text-center w-56 ">{reward.desc}</span>
              </motion.div>
            );
          })}
        </div>

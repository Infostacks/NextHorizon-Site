    ...
    <section
      ...
      <div className="max-w-screen-lg text-center flex items-center flex-col">
        ...
        <motion.span
          ...
          A dedicated development team services bring you the perk of tight cooperation with the
          team to stay on the same page. But these are not all the benefits you get from this model.
        </motion.span>
      </div>

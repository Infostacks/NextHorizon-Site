        ...
        <div className="max-w-screen-lg w-full flex items-center justify-center flex-col py-16 xl:gap-20 lg:gap-14 gap-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col gap-5 justify-center items-center w-full">
              ...
              <motion.p animate={fadeInAnimation} className="xl:text-3xl lg:text-3xl text-xl">
                MVP stands for a minimum valuable product. It’s a product with just enough features
                to be usable by first customers.
              </motion.p>
            </div>
          </div>

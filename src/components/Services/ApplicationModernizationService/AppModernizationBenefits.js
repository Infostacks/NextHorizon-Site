    ...
    <section
      ...
      <div className="max-w-screen-lg flex xl:flex-row lg:flex-row flex-col0 xl:mx-0 lg:mx-0 mx-10">
        ...
        <motion.span
          ...
          Legacy application modernization services can bring many benefits both for business of all
          sizes and domains.
        </motion.span>
      </div>
        ...
        {appModernizationServiceBenefits.map((benefit, index) => {
          return (
            <motion.div
              ...
              <span className="text-lg text-justify font-serif">{benefit.desc}</span>
            </motion.div>
          );
        })}
      </div>

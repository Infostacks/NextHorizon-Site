          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col justify-center items-center w-full gap-5">
              ...
              <p className="xl:text-xl lg:text-xl text-base">
                Aliquam interdum risus vitae lectus convallis sodales quis dignissim mi. Proin sem
                risus, aliquet in pretium eu, ultrices eu nibh. Sed eu metus mollis, fringilla
                ligula quis.
              </p>
            </div>
          </div>
            ...
            {faqs.map((faq, index) => {
              return (
                <motion.details
                  ...
                  <p className="mt-4 leading-relaxed text-gray-700 w-full">{faq.answer}</p>
                </motion.details>
              );
            })}
          </div>

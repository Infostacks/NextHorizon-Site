    ...
    <section
      ...
      <div className="max-w-screen-lg flex items-center xl:flex-row lg:flex-row flex-col gap-20 px-10">
        ...
        <motion.p
          ...
          We follow the Software Development Life Cycle (SDLC) process in our work. Preparation and
          project planning are important for further SDLC phases to reach cost-effective
          development. That's why we cover the Collecting requirements, Analysis, and Product design
          during thes discovery phase.
        </motion.p>
      </div>

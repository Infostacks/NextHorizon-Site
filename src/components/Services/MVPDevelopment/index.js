...
import LetTalkMVP from "./LetTalkMVP";
    ...
    <div className="flex flex-col items-center w-full overflow-x-hidden mt-40">
      ...
      <div
        ...
        <div className="flex flex-row gap-2 text-sm">
          ...
          <span>➙</span>
          <span className="hover:cursor-pointer text-slate-200">MVP Development</span>
        </div>
        ...
        <div className="flex flex-col gap-5 h-full text-white">
          ...
          <motion.p animate={rightAnimation} className="text-white text-xl">
            Our MVP app development company will help you design, develop, and launch a product with
            just enough features for early users.
          </motion.p>

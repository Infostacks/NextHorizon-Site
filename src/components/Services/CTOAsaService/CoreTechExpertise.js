    ...
    <div
      ...
      <div
        ...
        <div className="flex gap-5 flex-col xl:w-4/6 lg:w-4/6 w-5/6">
          ...
          <motion.div animate={upAnimation} className="max-w-lg mt-4 text-xl tracking-wide">
            With years of experience working on various industry-specific projects, our CTOs have a
            clear vision of how to build a product from scratch and polish it afterward.
          </motion.div>
      ...
      <div
        className={`flex flex-col xl:gap-10 lg:gap-10 gap-2 bg-${styles.redPrimary} text-white xl:w-1/2 lg:w-1/2 w-full xl:px-20 lg:px-14 px-10 h-full justify-center xl:py-0 lg:py-0 py-10`}>
        {/* Show Data  */}
        <div className="flex flex-col text-xl font-serif xl:gap-5 lg:gap-5 gap-2 xl:w-1/2 lg:w-1/2 w-full">
          ...
          <motion.span animate={upAnimation} className="xl:text-xl lg:text-xl text-base">
